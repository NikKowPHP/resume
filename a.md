...
<response>
  <reasoning>
    My plan is to update the projects section in `src/data/cv-data.json` with the new, more detailed information you provided. I will add the new projects and update the descriptions and technology stacks for the existing ones.

    To ensure each CV profile is tailored and appealing for its specific role, I will select the most relevant projects for each:

    1.  **Full Stack (AI Specialist) Profile:** I will highlight projects that showcase a blend of modern frontend, backend, and AI integration. I'll use "Lexity," "Interly," and the "Instagram Comment-to-DM Bot" to demonstrate this breadth of skill.
    2.  **Frontend Specialist Profile:** This profile will feature projects with a strong focus on user interface and modern frontend frameworks. I'll include "Lexity," "Interly," and your "Personal Portfolio Website" to emphasize expertise in Next.js and SvelteKit.
    3.  **Backend PHP Specialist Profile:** For this role, I'll prioritize projects that demonstrate deep backend expertise, especially with PHP/Laravel. The updated "ZIRO.FIT" project will be the centerpiece, complemented by the "Instagram Bot" (showing diverse backend skills) and a description of my backend work on educational PWAs.

    I will translate all new descriptions into French, Polish, and German to maintain consistency across languages. Finally, I will update the `TASKS.md` file to reflect this change.
  </reasoning>
  <modifications>
...
[
  {
    ...
    "data": {
      "fr": {
        ...
        "projects": [
          { "name": "Lexity : PWA d'Apprentissage Linguistique par l'IA", "url": "https://lexity.app", "description": "Une PWA qui révolutionne l'apprentissage des langues en passant de la consommation passive à la création active, avec des retours basés sur l'IA et des exercices de répétition des erreurs.", "stack_title": "Stack Technique", "stack": "<strong>Next.js, Supabase, PostgreSQL, Stripe, IA Multi-Fournisseur (Gemini, Groq), Tailwind CSS, Zustand.</strong>" },
          { "name": "Interly : Plateforme de Préparation aux Entretiens IA", "url": "https://interly.app", "description": "Une PWA pilotée par l'IA pour aider les utilisateurs à se préparer aux entretiens techniques grâce à une pratique vocale, des retours en temps réel et un processus systématique basé sur les données.", "stack_title": "Stack Technique", "stack": "<strong>Next.js, Supabase, PostgreSQL, Google Gemini, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Bot Instagram Commentaire-vers-DM", "url": "https://github.com/NikKowPHP", "description": "Un système automatisé qui envoie des DM aux utilisateurs qui commentent avec des mots-clés spécifiques sur les publications Instagram, géré via un panneau web.", "stack_title": "Stack Technique", "stack": "<strong>Python, Next.js, Docker, Supabase, PostgreSQL.</strong>" }
        ],
        "education": [
      ...
      "en": {
        ...
        "projects": [
          { "name": "Lexity: AI Language Learning PWA", "url": "https://lexity.app", "description": "A PWA that revolutionizes language learning by shifting from passive consumption to active creation, with AI-driven feedback and mistake-drilling exercises.", "stack_title": "Tech Stack", "stack": "<strong>Next.js, Supabase, PostgreSQL, Stripe, Multi-Provider AI (Gemini, Groq), Tailwind CSS, Zustand.</strong>" },
          { "name": "Interly: AI Interview Prep Platform", "url": "https://interly.app", "description": "An AI-driven PWA to help users prepare for technical interviews using voice-based practice, real-time feedback, and a systematic, data-driven process.", "stack_title": "Tech Stack", "stack": "<strong>Next.js, Supabase, PostgreSQL, Google Gemini, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Instagram Comment-to-DM Bot System", "url": "https://github.com/NikKowPHP", "description": "An automated system that sends DMs to users who comment with specific keywords on Instagram posts, managed via a web panel.", "stack_title": "Tech Stack", "stack": "<strong>Python, Next.js, Docker, Supabase, PostgreSQL.</strong>" }
        ],
        "education": [
      ...
      "pl": {
        ...
        "projects": [
          { "name": "Lexity: PWA do Nauki Języków z AI", "url": "https://lexity.app", "description": "PWA, która rewolucjonizuje naukę języków, przechodząc od pasywnej konsumpcji do aktywnego tworzenia, z informacjami zwrotnymi opartymi na AI i ćwiczeniami utrwalającymi błędy.", "stack_title": "Stos technologiczny", "stack": "<strong>Next.js, Supabase, PostgreSQL, Stripe, Multi-Provider AI (Gemini, Groq), Tailwind CSS, Zustand.</strong>" },
          { "name": "Interly: Platforma AI do Przygotowania do Rozmów Kwalifikacyjnych", "url": "https://interly.app", "description": "PWA napędzana przez AI, aby pomóc użytkownikom przygotować się do rozmów technicznych za pomocą ćwiczeń głosowych, informacji zwrotnych w czasie rzeczywistym i systematycznego procesu opartego na danych.", "stack_title": "Stos technologiczny", "stack": "<strong>Next.js, Supabase, PostgreSQL, Google Gemini, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Bot Instagram Komentarz-do-DM", "url": "https://github.com/NikKowPHP", "description": "Zautomatyzowany system, który wysyła wiadomości DM do użytkowników komentujących posty na Instagramie za pomocą określonych słów kluczowych, zarządzany przez panel internetowy.", "stack_title": "Stos technologiczny", "stack": "<strong>Python, Next.js, Docker, Supabase, PostgreSQL.</strong>" }
        ],
        "education": [
      ...
      "de": {
        ...
        "projects": [
          { "name": "Lexity: KI-Sprachlern-PWA", "url": "https://lexity.app", "description": "Eine PWA, die das Sprachenlernen revolutioniert, indem sie von passivem Konsum zu aktivem Schaffen übergeht, mit KI-gestütztem Feedback und Übungen zum Einprägen von Fehlern.", "stack_title": "Technologie-Stack", "stack": "<strong>Next.js, Supabase, PostgreSQL, Stripe, Multi-Provider AI (Gemini, Groq), Tailwind CSS, Zustand.</strong>" },
          { "name": "Interly: KI-Plattform zur Vorbereitung auf Vorstellungsgespräche", "url": "https://interly.app", "description": "Eine KI-gesteuerte PWA, die Benutzern hilft, sich auf technische Vorstellungsgespräche vorzubereiten, indem sie sprachbasiertes Üben, Echtzeit-Feedback und einen systematischen, datengesteuerten Prozess verwendet.", "stack_title": "Technologie-Stack", "stack": "<strong>Next.js, Supabase, PostgreSQL, Google Gemini, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Instagram Kommentar-zu-DM-Bot-System", "url": "https://github.com/NikKowPHP", "description": "Ein automatisiertes System, das DMs an Benutzer sendet, die mit bestimmten Schlüsselwörtern auf Instagram-Posts kommentieren, verwaltet über ein Web-Panel.", "stack_title": "Technologie-Stack", "stack": "<strong>Python, Next.js, Docker, Supabase, PostgreSQL.</strong>" }
        ],
        "education": [
  ...
  },
  {
    ...
    "data": {
      "fr": {
        ...
        "projects": [
          { "name": "Lexity : PWA d'Apprentissage Linguistique par l'IA", "url": "https://lexity.app", "description": "Une PWA qui révolutionne l'apprentissage des langues en passant de la consommation passive à la création active, avec des retours basés sur l'IA et des exercices de répétition des erreurs.", "stack_title": "Stack Technique", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Tiptap, Zustand, React Query.</strong>" },
          { "name": "Interly : Plateforme de Préparation aux Entretiens IA", "url": "https://interly.app", "description": "Une PWA pilotée par l'IA pour aider les utilisateurs à se préparer aux entretiens techniques grâce à une pratique vocale, des retours en temps réel et un processus systématique basé sur les données.", "stack_title": "Stack Technique", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Site Portfolio Personnel", "url": "https://mikita-kavaliou.online", "description": "Un site de portfolio personnel conçu pour expérimenter avec SvelteKit, démontrant un développement rapide et des principes de design modernes.", "stack_title": "Stack Technique", "stack": "<strong>SvelteKit, Svelte, TypeScript, Tailwind CSS.</strong>" }
        ],
        "education": [
          { "degree": "Diplôme de Technicien en Radio-électronique (équivalent Bac+4)", "institution": "Collège d'État Supérieur de Radiotechnique de Minsk", "period": "2015 - 2019" }
        ]
      ...
      "en": {
        ...
        "projects": [
          { "name": "Lexity: AI Language Learning PWA", "url": "https://lexity.app", "description": "A PWA that revolutionizes language learning by shifting from passive consumption to active creation, with AI-driven feedback and mistake-drilling exercises.", "stack_title": "Tech Stack", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Tiptap, Zustand, React Query.</strong>" },
          { "name": "Interly: AI Interview Prep Platform", "url": "https://interly.app", "description": "An AI-driven PWA to help users prepare for technical interviews using voice-based practice, real-time feedback, and a systematic, data-driven process.", "stack_title": "Tech Stack", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Personal Portfolio Website", "url": "https://mikita-kavaliou.online", "description": "A personal portfolio site built to experiment with SvelteKit, demonstrating rapid development and modern design principles.", "stack_title": "Tech Stack", "stack": "<strong>SvelteKit, Svelte, TypeScript, Tailwind CSS.</strong>" }
        ],
        "education": [
          { "degree": "Diploma of Technician in Radio-electronics (equivalent to Bachelor's degree)", "institution": "Minsk State Higher College of Radiotechnics", "period": "2015 - 2019" }
        ]
      ...
      "pl": {
        ...
        "projects": [
          { "name": "Lexity: PWA do Nauki Języków z AI", "url": "https://lexity.app", "description": "PWA, która rewolucjonizuje naukę języków, przechodząc od pasywnej konsumpcji do aktywnego tworzenia, z informacjami zwrotnymi opartymi na AI i ćwiczeniami utrwalającymi błędy.", "stack_title": "Stos technologiczny", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Tiptap, Zustand, React Query.</strong>" },
          { "name": "Interly: Platforma AI do Przygotowania do Rozmów Kwalifikacyjnych", "url": "https://interly.app", "description": "PWA napędzana przez AI, aby pomóc użytkownikom przygotować się do rozmów technicznych za pomocą ćwiczeń głosowych, informacji zwrotnych w czasie rzeczywistym i systematycznego procesu opartego na danych.", "stack_title": "Stos technologiczny", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Osobista Strona Portfolio", "url": "https://mikita-kavaliou.online", "description": "Osobista strona portfolio stworzona w celu eksperymentowania z SvelteKit, demonstrująca szybki rozwój i nowoczesne zasady projektowania.", "stack_title": "Stos technologiczny", "stack": "<strong>SvelteKit, Svelte, TypeScript, Tailwind CSS.</strong>" }
        ],
        "education": [
          { "degree": "Dyplom Technika Radioelektroniki (odpowiednik licencjatu)", "institution": "Mińskie Państwowe Wyższe Kolegium Radiotechniczne", "period": "2015 - 2019" }
        ]
      ...
      "de": {
        ...
        "projects": [
          { "name": "Lexity: KI-Sprachlern-PWA", "url": "https://lexity.app", "description": "Eine PWA, die das Sprachenlernen revolutioniert, indem sie von passivem Konsum zu aktivem Schaffen übergeht, mit KI-gestütztem Feedback und Übungen zum Einprägen von Fehlern.", "stack_title": "Technologie-Stack", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Tiptap, Zustand, React Query.</strong>" },
          { "name": "Interly: KI-Plattform zur Vorbereitung auf Vorstellungsgespräche", "url": "https://interly.app", "description": "Eine KI-gesteuerte PWA, die Benutzern hilft, sich auf technische Vorstellungsgespräche vorzubereiten, indem sie sprachbasiertes Üben, Echtzeit-Feedback und einen systematischen, datengesteuerten Prozess verwendet.", "stack_title": "Technologie-Stack", "stack": "<strong>Next.js, TypeScript, Tailwind CSS, Zustand, Zod.</strong>" },
          { "name": "Persönliche Portfolio-Website", "url": "https://mikita-kavaliou.online", "description": "Eine persönliche Portfolio-Website, die zum Experimentieren mit SvelteKit erstellt wurde und schnelle Entwicklung sowie moderne Designprinzipien demonstriert.", "stack_title": "Technologie-Stack", "stack": "<strong>SvelteKit, Svelte, TypeScript, Tailwind CSS.</strong>" }
        ],
        "education": [
          { "degree": "Diplom als Techniker für Radioelektronik (entspricht Bachelor-Abschluss)", "institution": "Staatliches Höheres Kolleg für Radiotechnik Minsk", "period": "2015 - 2019" }
        ]
  ...
  },
  {
    ...
    "data": {
      "fr": {
        ...
        "projects": [
          { "name": "ZIRO.FIT : Plateforme pour Coachs Sportifs", "url": "https://ziro.fit", "description": "Une carte de visite numérique et une plateforme d'engagement client pour les coachs sportifs. J'ai développé l'ensemble du backend avec Laravel, y compris un schéma de base de données complexe, la logique métier et un assistant IA pour la génération de programmes d'entraînement.", "stack_title": "Stack Technique", "stack": "<strong>Laravel, Livewire, PostgreSQL, AWS, Alpine.js.</strong>" },
          { "name": "Bot Instagram Commentaire-vers-DM", "url": "https://github.com/NikKowPHP", "description": "Un système automatisé qui envoie des DM aux utilisateurs qui commentent avec des mots-clés spécifiques sur les publications Instagram, géré via un panneau web.", "stack_title": "Stack Technique", "stack": "<strong>Python, Docker, Supabase (PostgreSQL), Next.js.</strong>" },
          { "name": "Backend pour PWA Éducatives", "url": "https://lexity.app", "description": "Conception et implémentation de l'architecture backend et des API RESTful avec <strong>Supabase (PostgreSQL)</strong> et des fonctions serverless TypeScript pour alimenter plusieurs PWA <strong>Next.js</strong>, en se concentrant sur la modélisation des données et l'authentification.", "stack_title": "Stack Technique", "stack": "<strong>Supabase, PostgreSQL, TypeScript (Edge Functions).</strong>" }
        ],
        "education": [
          { "degree": "Diplôme de Technicien en Radio-électronique (équivalent Bac+4)", "institution": "Collège d'État Supérieur de Radiotechnique de Minsk", "period": "2015 - 2019" }
        ]
      ...
      "en": {
        ...
        "projects": [
          { "name": "ZIRO.FIT: Fitness Trainer Platform", "url": "https://ziro.fit", "description": "A digital business card and client engagement platform for fitness trainers. Developed the entire backend with Laravel, including a complex database schema, business logic, and an AI assistant for workout generation.", "stack_title": "Tech Stack", "stack": "<strong>Laravel, Livewire, PostgreSQL, AWS, Alpine.js.</strong>" },
          { "name": "Instagram Comment-to-DM Bot System", "url": "https://github.com/NikKowPHP", "description": "An automated system that sends DMs to users who comment on posts. Built the backend logic in Python and the management panel in Next.js, all containerized with Docker.", "stack_title": "Tech Stack", "stack": "<strong>Python, Docker, Supabase (PostgreSQL), Next.js.</strong>" },
          { "name": "Backend for Educational PWAs", "url": "https://lexity.app", "description": "Designed and implemented the backend architecture and RESTful APIs using Supabase (PostgreSQL) and serverless TypeScript functions to power multiple Next.js PWAs, focusing on scalable data modeling and authentication.", "stack_title": "Tech Stack", "stack": "<strong>Supabase, PostgreSQL, TypeScript (Edge Functions).</strong>" }
        ],
        "education": [
          { "degree": "Diploma of Technician in Radio-electronics (equivalent to Bachelor's degree)", "institution": "Minsk State Higher College of Radiotechnics", "period": "2015 - 2019" }
        ]
      ...
      "pl": {
        ...
        "projects": [
          { "name": "ZIRO.FIT: Platforma dla Trenerów Fitness", "url": "https://ziro.fit", "description": "Cyfrowa wizytówka i platforma do angażowania klientów dla trenerów fitness. Opracowałem cały backend w Laravel, w tym złożony schemat bazy danych, logikę biznesową i asystenta AI do generowania planów treningowych.", "stack_title": "Stos Technologiczny", "stack": "<strong>Laravel, Livewire, PostgreSQL, AWS, Alpine.js.</strong>" },
          { "name": "Bot Instagram Komentarz-do-DM", "url": "https://github.com/NikKowPHP", "description": "Zautomatyzowany system, który wysyła wiadomości DM do użytkowników komentujących posty na Instagramie za pomocą określonych słów kluczowych, zarządzany przez panel internetowy.", "stack_title": "Stos Technologiczny", "stack": "<strong>Python, Docker, Supabase (PostgreSQL), Next.js.</strong>" },
          { "name": "Backend dla Edukacyjnych PWA", "url": "https://lexity.app", "description": "Zaprojektowanie i wdrożenie architektury backendu oraz API RESTful przy użyciu Supabase (PostgreSQL) i funkcji serverless w TypeScript do zasilania wielu PWA Next.js, koncentrując się na skalowalnym modelowaniu danych i uwierzytelnianiu.", "stack_title": "Stos Technologiczny", "stack": "<strong>Supabase, PostgreSQL, TypeScript (Edge Functions).</strong>" }
        ],
        "education": [
          { "degree": "Dyplom Technika Radioelektroniki (odpowiednik licencjatu)", "institution": "Mińskie Państwowe Wyższe Kolegium Radiotechniczne", "period": "2015 - 2019" }
        ]
      ...
      "de": {
        ...
        "projects": [
          { "name": "ZIRO.FIT: Plattform für Fitnesstrainer", "url": "https://ziro.fit", "description": "Eine digitale Visitenkarte und Kundenbindungsplattform für Fitnesstrainer. Entwicklung des gesamten Backends mit Laravel, einschließlich eines komplexen Datenbankschemas, Geschäftslogik und eines KI-Assistenten zur Trainingsplanerstellung.", "stack_title": "Technologie-Stack", "stack": "<strong>Laravel, Livewire, PostgreSQL, AWS, Alpine.js.</strong>" },
          { "name": "Instagram Kommentar-zu-DM-Bot-System", "url": "https://github.com/NikKowPHP", "description": "Ein automatisiertes System, das DMs an Benutzer sendet, die mit bestimmten Schlüsselwörtern auf Instagram-Posts kommentieren, verwaltet über ein Web-Panel.", "stack_title": "Technologie-Stack", "stack": "<strong>Python, Docker, Supabase (PostgreSQL), Next.js.</strong>" },
          { "name": "Backend für Bildungs-PWAs", "url": "https://lexity.app", "description": "Entwurf und Implementierung der Backend-Architektur und RESTful-APIs mit Supabase (PostgreSQL) und serverlosen TypeScript-Funktionen, um mehrere Next.js-PWAs zu betreiben, mit Fokus auf skalierbarer Datenmodellierung und Authentifizierung.", "stack_title": "Technologie-Stack", "stack": "<strong>Supabase, PostgreSQL, TypeScript (Edge Functions).</strong>" }
        ],
        "education": [
          { "degree": "Diplom als Techniker für Radioelektronik (entspricht Bachelor-Abschluss)", "institution": "Staatliches Höheres Kolleg für Radiotechnik Minsk", "period": "2015 - 2019" }
        ]
...
- [x] Fix CV profile dropdown not updating due to localStorage caching.
- [x] Add more project details to the CV data.
      ]]>
    </file>
  </modifications>
</response>
